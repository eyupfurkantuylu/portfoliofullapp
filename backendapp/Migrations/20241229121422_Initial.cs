        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mlh = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Href = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HackathonId = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HackathonLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HackathonLinks_Hackathons_HackathonId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Icon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Navbar = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Education_Order",
                table: "Education",
                column: "Order");

            migrationBuilder.CreateIndex(
                name: "IX_HackathonLinks_HackathonId",
                table: "HackathonLinks",
                column: "HackathonId");

            migrationBuilder.CreateIndex(
                name: "IX_HackathonLinks_Order",
                table: "HackathonLinks",
                column: "Order");

            migrationBuilder.CreateIndex(
                name: "IX_Hackathons_Order",
                table: "Hackathons",
                column: "Order");

            migrationBuilder.CreateIndex(
                name: "IX_NavbarItems_Order",
                table: "NavbarItems",
                column: "Order");
